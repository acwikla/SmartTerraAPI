...
namespace SmartTerraAPI.Migrations
{
    ...
    [Migration("20201111134018_AddDevicePropertiesTable")]
    partial class AddDevicePropertiesTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartTerraAPI.Models.DeviceProperties", b =>
                {
                    ...
                    b.Property<bool>("isWaterLevelSufficient")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("SmartTerraAPI.Models.DeviceProperties", b =>
                {
                    b.HasOne("SmartTerraAPI.Models.Device", "Device")
                        .WithOne("DeviceProperties")
                        .HasForeignKey("SmartTerraAPI.Models.DeviceProperties", "DeviceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
